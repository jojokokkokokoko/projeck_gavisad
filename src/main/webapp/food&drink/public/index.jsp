...
<html lang="en-US" dir="ltr">
	<head>
		...
		<!--    Document Title-->
		<!-- ===============================================-->
		<title>Food&Drink | Responsive, Ecommerce &amp;</title>
		...
		<link
			...
			sizes="180x180"
			href="assets/img/favicons/food (1).png"
		/>
		<link
			rel="icon"
			type="image/png"
		...
		<meta
			...
			content="assets/img/favicons/food (1).png"
		/>
		...
		<main class="main" id="top">
				...
				<div class="container">
					<a class="navbar-brand d-inline-flex" href="index.html">
						...
						><img
							...
							src="assets/img/gallery/food (1).png"
							width="15.6px"
							height="40px"
							alt="logo"
					/></a>
					...
					>
						<div class="mx-auto pt-5 pt-lg-0 d-block d-lg-none d-xl-block">
							...
							>
								<li>
									<a href="#" class="nav-link px-2 text-black">ຫນ້າຫຼັກ</a>
								</li>
								<li><a href="#" class="nav-link px-2 text-black">ເມນູ</a></li>
								<li>
									<a href="#" class="nav-link px-2 text-black">ໂປຣໂມຊັ້ນ</a>
								</li>
								<li><a href="#" class="nav-link px-2 text-black">ກ່ຽວກັບ</a></li>
							</ul>
						</div>
						<div></div>
						<form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0">
							...
							<button
								...
								type="submit"
							>
								<a href="login.jsp"><!--Login-->ເຂົ້າສູ່ລະບົບ </a> <i class="fas fa-user me-2"></i>
							</button>
					...
					<div class="row flex-center">
						...
						<div class="col-md-7 col-lg-6 py-8 text-md-start text-center">
							...
							<h1 class="text-800 mb-5 fs-4">
								ພຽງແຕ່ທ່ານຄລິກຄັ້ງດຽວ, ຄົ້ນຫາອາຫານ<br
									class="d-none d-xxl-block"
								/>ທີ່ຢູ່ໃກ້ທ່ານ ອາຫານກໍ່ຮອດແລ້ວ
							</h1>
											...
											<form class="row gx-2 gy-2 align-items-center">
												<div class="col">
													<div class="input-group-icon">
														<i
															class="fas fa-map-marker-alt text-danger input-box-icon"
														></i>
			...
			<section>
				<div
					class="bg-holder"
					style="
						background-image: url(assets/img/gallery/cta-one-bg.png);
											...
											>
												...
												<div class="d-flex d-lg-block d-xl-flex flex-center">
													<h2 class="fw-bolder text-1000 mb-0 text-gradient">
														Daily<br class="d-none d-md-block" />Discounts
													</h2>
												</div>
											</div>
										</div>
					...
					<div class="row flex-center mt-md-8">
						...
						<div class="col-lg-5 mt-7 mt-md-0">
							...
							<p>
								...
								<br class="d-none d-xl-block" />discounts and you'll be lost in
					...
					<div class="row justify-content-lg-between">
						...
						<div class="col-6 col-md-4 col-lg-auto mb-3">
							<ul class="list-unstyled mb-md-4 mb-lg-0">
								...
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Miami</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!"
										>San Diego</a
						...
						<div class="col-6 col-md-4 col-lg-auto mb-3">
							<ul class="list-unstyled mb-md-4 mb-lg-0">
								...
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Seattle</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!"
										>Portland</a
						...
						<div class="col-6 col-md-4 col-lg-auto mb-3">
							<ul class="list-unstyled mb-md-4 mb-lg-0">
								...
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Atlanta</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!"
										>Charlotte</a
								...
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Denver</a>
								</li>
							</ul>
						</div>
						<div class="col-6 col-md-4 col-lg-auto mb-3">
							<ul class="list-unstyled mb-md-4 mb-lg-0">
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Chicago</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Phoenix</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!"
										>Las Vegas</a
					...
					<div class="row">
						<div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-3">
							...
							<ul class="list-unstyled mb-md-4 mb-lg-0">
								...
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Team</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">Careers</a>
								</li>
								<li class="lh-lg">
									<a class="text-200 text-decoration-none" href="#!">blog</a>
								</li>
							</ul>
						</div>
